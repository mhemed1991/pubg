...
BOOL Algorithm::WorldToScreen(VECTOR3 Position, VECTOR3& Screen, INT* Distance, D3DMATRIX ViewMatrix)
{
	...
	*Distance = (ScreenW / 100);
	...
	ScreenW = 1 / ScreenW;
	FLOAT SightX = (DX11::Width / 2);
	FLOAT SightY = (DX11::Height / 2);
...
BOOL Algorithm::WorldToScreenPlayer(VECTOR3 Position, VECTOR3& Screen, INT* Distance, D3DMATRIX ViewMatrix)
{
	...
	*Distance = (ScreenW / 100);
	...
	Screen.X = (DX11::Width / 2) + (DX11::Width / 2) * ScreenX / ScreenW;
	Screen.Y = (DX11::Height / 2) - (DX11::Height / 2) * ScreenY / ScreenW;
	FLOAT Y1 = (DX11::Height / 2) - (ViewMatrix._12 * Position.X + ViewMatrix._22 * Position.Y + ViewMatrix._32 * (Position.Z - 95) + ViewMatrix._42) * (DX11::Height / 2) / ScreenW;
